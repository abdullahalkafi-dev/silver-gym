...
const normalizePermissions = (
  ...
  canManageMembers: Boolean(input?.canManageMembers),
  canManagePackages: Boolean(input?.canManagePackages),
  canManagePayments: Boolean(input?.canManagePayments),
  canManageBilling: Boolean(input?.canManageBilling),
  canManageExpenses: Boolean(input?.canManageExpenses),
  canManageLockers: Boolean(input?.canManageLockers),
});
