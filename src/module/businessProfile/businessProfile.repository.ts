...
export const BusinessProfileRepository = {
  create(payload: TBusinessProfile) {
    return BusinessProfile.create(payload);
  },

  findById(id: string) {
    return BusinessProfile.findById(id);
  },

  findOne(filter: object) {
    return BusinessProfile.findOne(filter);
  },
  ...
  deleteById(id: string) {
    return BusinessProfile.findByIdAndDelete(id);
  },

  async exists(filter: object) {
    const doc = await BusinessProfile.exists(filter);
    return Boolean(doc);
  },

  count(filter: object = {}) {
    return BusinessProfile.countDocuments(filter);
  },
};
