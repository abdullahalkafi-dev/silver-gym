...
const roleSchema = new Schema<TRole>(
  {
    ...
    canEditSMSTemplate: { type: Boolean, default: false },
    ...
    canViewLockers: { type: Boolean, default: false },
    canAddLocker: { type: Boolean, default: false },
    canDeleteLocker: { type: Boolean, default: false },
    canAssignLocker: { type: Boolean, default: false },
    canCollectLockerPayment: { type: Boolean, default: false },
  },
  {
    timestamps: true,
  }
